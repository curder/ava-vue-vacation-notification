<template>
  <div id="app" class="antialiased text-gray-900 flex flex-col min-h-screen bg-gray-100">
    ...
    <div class="flex-shrink-0 py-12 text-center">
      ...
      <div class="mt-2">
        <a target="_blank" href="https://github.com/curder/ava-vue-vacation-notification" class="text-sm font-semibold text-gray-600 hover:underline">Source on GitHub</a>
      </div>
    </div>
  </div>
</template>
